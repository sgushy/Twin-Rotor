...
/// @brief Literally just runs setup error checks and then ends
/// @param pvParam 
static void setupTask(void *pvParam)
{
...
void app_main(void)
{
    ...
    xTaskCreatePinnedToCore(sampleTask, "sampleTask", 4096, (void*) 1, 10, NULL, 0);
    //xTaskCreatePinnedToCore(setupTask, "setupTask", 4096, (void*) 1, 5, NULL, 1);
#ifdef CONFIG_EXAMPLE_IPV4
    //xTaskCreatePinnedToCore(tcp_server_task, "tcp_server", 4096, (void*)AF_INET, 5, NULL, 1);
#endif
#ifdef CONFIG_EXAMPLE_IPV6
    //xTaskCreatePinnedToCore(tcp_server_task, "tcp_server", 4096, (void*)AF_INET6, 5, NULL, 1);
#endif
}
